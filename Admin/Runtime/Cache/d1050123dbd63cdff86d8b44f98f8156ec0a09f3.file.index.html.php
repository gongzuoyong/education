<?php /* Smarty version Smarty-3.1.6, created on 2018-06-20 20:14:25
         compiled from "./Admin/Tpl\Flink\index.html" */ ?>
<?php /*%%SmartyHeaderCode:147195b2a4521940ed0-44021482%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1050123dbd63cdff86d8b44f98f8156ec0a09f3' => 
    array (
      0 => './Admin/Tpl\\Flink\\index.html',
      1 => 1392262976,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147195b2a4521940ed0-44021482',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b2a4521a168c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b2a4521a168c')) {function content_5b2a4521a168c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
	...
	<div class="searchBar">
		<table class="searchContent">
            <tr>
                <td>搜索：</td>
				<td>
                    链接名：<input type="text" name="webname" size="8" value="<?php echo $_POST['webname'];?>
"/>
                </td>
                <td>
                    描述：<input type="text" name="descr" size="8" value="<?php echo $_POST['descr'];?>
"/>
                </td>
                <td>
...
">
                ...
                <td><?php echo $_smarty_tpl->tpl_vars['vo']->value['webname'];?>
</td>
                ...
                <td>
                    <?php if ($_smarty_tpl->tpl_vars['vo']->value['status']==1){?>新添加<?php }elseif($_smarty_tpl->tpl_vars['vo']->value['status']==2){?>在用<?php }else{ ?>废弃<?php }?>
                </td>
            </tr>
            <?php } ?>
