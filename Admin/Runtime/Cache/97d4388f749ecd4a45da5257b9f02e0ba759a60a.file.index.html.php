<?php /* Smarty version Smarty-3.1.6, created on 2018-06-20 20:14:18
         compiled from "./Admin/Tpl\Notice\index.html" */ ?>
<?php /*%%SmartyHeaderCode:272945b2a451ad20bf5-68441949%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '272945b2a451ad20bf5-68441949',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b2a451ade71c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b2a451ade71c')) {function content_5b2a451ade71c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
<div class="pageContent">
	<div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="__URL__/detail/id/{sid_user}/navTabId/listnotice" target="dialog" width="700" height="500" title="浏览公告详情"><span>浏览公告详情</span></a></li>
			<li><a class="delete" href="__URL__/delete/id/{sid_user}/navTabId/listnotice" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="__URL__/edit/id/{sid_user}/navTabId/listnotice"  width="700" height="500" target="dialog"><span>修改公告信息</span></a></li>
